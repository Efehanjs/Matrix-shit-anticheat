...
public class ParserImpl$ParseFlowSequenceEntryMappingValue implements Production {
    ...
    if (ParserImpl.this.scanner.checkToken(new Token.ID[] { Token.ID.Value })) {
      ...
      try {
        if (!ParserImpl.this.scanner.checkToken(new Token.ID[] { Token.ID.FlowEntry, Token.ID.FlowSequenceEnd })) {
          ParserImpl.access$500(ParserImpl.this).push(new ParserImpl$ParseFlowSequenceEntryMappingEnd(ParserImpl.this, null));
          return ParserImpl.access$2400(ParserImpl.this);
        } 
      } catch (RuntimeException runtimeException) {
        throw a(null);
      } 
      ParserImpl.access$102(ParserImpl.this, new ParserImpl$ParseFlowSequenceEntryMappingEnd(ParserImpl.this, null));
...
/* Location:              C:\Users\Administrator\Desktop\Matrix_7.0.0_alpha28(3)(1).jar!\me\rerere\matrix\thirdparty\org\simpleyaml\configuration\implementation\snakeyaml\lib\parser\ParserImpl$ParseFlowSequenceEntryMappingValue.class
